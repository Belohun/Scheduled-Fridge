...
class ListOfProductsAdapter internal constructor(val context: Context?, private val homeViewModel: HomeViewModel): RecyclerView.Adapter<ListOfProductsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val pair = itemViewOnClickListener(holder, isSelectedMode, isSelected, context, current)
        isSelected = pair.first
        isSelectedMode = pair.second
                    ...
                    mAlertDialog.btn_add.setOnClickListener {
                        ...
                        if (noErrors) {
                            ...
                            if (product.productExpirationDate != "") {
                                generateNotification(product.id,product.productExpirationDate,product.productName,product.productType,context)
                            }
    ...
    private fun itemViewOnClickListener(
        ...
        return Pair(isSelected1, isSelectedMode1)
    }
